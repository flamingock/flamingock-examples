...
> While primarily focused on cloud-based solutions, Flamingock also supports users’ own infrastructure with local drivers for main databases like MongoDB, DynamoDB, and Couchbase
