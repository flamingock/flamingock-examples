...
package io.flamingock.mongock.importer.local.client;

import io.flamingock.mongock.importer.local.ImporterApplication;
...
@Document(collection = ImporterApplication.CLIENTS_COLLECTION_NAME)
@CompoundIndexes({
