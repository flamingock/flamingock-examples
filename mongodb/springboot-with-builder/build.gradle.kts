...
//    Flamingock Dependencies
    ...
    implementation("io.flamingock:flamingock-ce-mongodb-springdata-v3-legacy")
    implementation("io.flamingock:flamingock-springboot-integration-v2-legacy:$flamingockVersion") // TODO: NOT IN BOM YET
