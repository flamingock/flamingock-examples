...
package io.flamingock.examples.mongodb.springboot.builder.client;

import io.flamingock.examples.mongodb.springboot.builder.SpringbootWithFlamingockBuilder;
...
@Document(collection = SpringbootWithFlamingockBuilder.CLIENTS_COLLECTION_NAME)
@CompoundIndexes({
